...
if __name__ == '__main__':
    ...
    job_req_translator.addTranslationToJobInfo(jobinfo_path=jobinfo_path, translation_path=translated_jobinfo_path, output_path=final_jobinfo_path) # job_idx begins from 0